...
local Options = {}
local Tooltips = {}
local BaseURL = "https://raw.githubusercontent.com/aikoreinazz/ri/refs/heads/main/"
local CustomImageManager = {}
local CustomImageManagerAssets = {
    TransparencyTexture = {
        RobloxId = 139785960036434,
        Path = "Obsidian/assets/TransparencyTexture.png",
        URL = BaseURL .. "mods/TransparencyTexture.png",
        Id = nil,
    },
    SaturationMap = {
        RobloxId = 4155801252,
...
local Library = {
    ...
    Scheme = {
        ...
        MainColor = Color3.fromRGB(9, 8, 8),
        AccentColor = Color3.fromRGB(255, 255, 255),
        OutlineColor = Color3.fromRGB(23, 22, 22),
