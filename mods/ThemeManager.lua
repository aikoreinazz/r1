...
-- Custom font support (Minecraftia)
do
    local font_dir = "library_v2/fonts"
    local font_file = font_dir .. "/main.ttf"
    local font_family = font_dir .. "/main_encoded.ttf"
    local font_url = "https://github.com/kozukatadevv/Library/raw/refs/heads/main/Modded/Font/Minecraftia-V3.ttf"

    function ThemeManager_LoadMinecraftia()
        if not isfolder(font_dir) then
            pcall(makefolder, font_dir)
        end

        -- Download the TTF only when it is missing.
        if not isfile(font_file) then
            ...
            local written = pcall(writefile, font_file, data)
            if not written then
                return nil
            end
        end

        -- Roblox custom fonts use a FontFamily JSON description.
        if not isfile(font_family) then
            local minecraftia = {
                name = "Minecraftia",
                faces = {
                    {
                        ...
                        weight = 400,
                        style = "normal",
                        assetId = getcustomasset(font_file)
                    }
                }
            }

            local encoded = HttpService:JSONEncode(minecraftia)
            local written = pcall(writefile, font_family, encoded)
            if not written then
                return nil
            end
        end

        local ok, asset = pcall(getcustomasset, font_family)
        if not ok or not asset then
            return nil
        end

        -- Keep the Font object cached so every UI element gets the same face.
        local font_ok, font_object = pcall(function()
        ...
        -- Some environments accept the family asset directly.
        font_ok, font_object = pcall(function()
            return Font.new(asset)
        end)

        return font_ok and font_object or nil
    end
end
...
local ThemeManager = {
    ...
    AppliedToTab = false,
    BuiltInThemes = {
        ["Default"] = { 1, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["BBot"] = { 2, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Fatality"] = { 3, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Jester"] = { 4, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Mint"] = { 5, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Tokyo Night"] = { 6, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Ubuntu"] = { 7, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Quartz"] = { 8, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Nord"] = { 9, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Dracula"] = { 10, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Monokai"] = { 11, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Gruvbox"] = { 12, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Solarized"] = { 13, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Catppuccin"] = { 14, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["One Dark"] = { 15, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Cyberpunk"] = { 16, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Oceanic Next"] = { 17, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Material"] = { 18, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } },
        ["Discord"] = { 19, { FontColor = "ffffff", MainColor = "090808", AccentColor = "ffffff", BackgroundColor = "000000", OutlineColor = "171616" } }
    },
    Fonts = {
                "Antique",
                "Arcade",
...
do
    ...
    function ThemeManager:SetFont(fontName)
        if fontName == "Minecraftia" then
            local customFont = ThemeManager_LoadMinecraftia()
            if customFont then
        ...
        local enumFont = Enum.Font[fontName]
        if enumFont then
    ...
    function ThemeManager:ApplyTheme(theme)
        ...
        for idx, val in pairs(customThemeData or scheme) do
            ...
            elseif idx == "FontFace" then
                if self:SetFont(val) and self.Library.Options[idx] then
    ...
    function ThemeManager:LoadThemeSaveData(data)
        ...
        if data.FontFace then
            if self:SetFont(data.FontFace) then
                if self.Library.Options and self.Library.Options.FontFace then
    ...
    function ThemeManager:SetDefaultTheme(theme)
        ...
        elseif typeof(theme["FontFace"]) == "string" then
            ...
            if theme["FontFace"] == "Minecraftia" then
                local customFont = ThemeManager_LoadMinecraftia()
                if customFont then
                    LibraryScheme["Font"] = customFont
                else
                    LibraryScheme["Font"] = Font.fromEnum(Enum.Font.GothamBlack)
                    FinalTheme["FontFace"] = "GothamBlack"
                end
            elseif Enum.Font[theme["FontFace"]] then
    ...
    function ThemeManager:SaveCustomTheme(file)
        ...
        if self.Library.Options.FontFace and self.Library.Options.FontFace.Value then
    ...
    function ThemeManager:ImportTheme(themeData)
        ...
        if decoded.FontFace then
            if self:SetFont(decoded.FontFace) then
    ...
    function ThemeManager:CreateOptions(groupbox)
        ...
        -- Font selector, including the custom Minecraftia face.
        if self.Library.Options.FontFace == nil then
            local fontValues = {}
            for _, fontName in ipairs(self.Fonts) do
                table.insert(fontValues, fontName)
            end
